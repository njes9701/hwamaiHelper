...
*   設定檔位於 `.minecraft/config/hwamaihelper_config.json`，可手動新增更多快捷鍵與指令對應。
...
## 🛠️ 設定檔
設定檔位於 `.minecraft/config/hwamaihelper_config.json`，包含所有快捷鍵、功能開關與暱稱存檔。
